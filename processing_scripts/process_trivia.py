...
def write_trivia_instances_to_filepath(raw_instances, output_directory: str, set_name: str):
    ...
    with open(output_directory, "w") as output_file:
        ...
        for idx, raw_instance in tqdm(enumerate(raw_instances)):
            ...
            processed_instance["question_id"] = 'single_trivia_'+set_name+'_'+str(idx)
...
if __name__ == "__main__":
    ...
    input_directory = os.path.join("./datasets/QA/", "trivia", "trivia")
    output_directory = os.path.join("./datasets/QA/", "trivia", "trivia")
