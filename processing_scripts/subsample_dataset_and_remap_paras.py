...
def main():
    ...
    parser.add_argument(
        "dataset_name", type=str, help="dataset name.", choices=('hotpotqa', 'nq', 'trivia', 'squad')
    )
    ...
    if args.set_name == "test":
        dev_file_path = os.path.join("./datasets/QA/", args.dataset_name, args.dataset_name, "dev_subsampled.jsonl")
        if args.dataset_name == 'hotpotqa':
            dev_file_path = os.path.join("./datasets/QA/", args.dataset_name, "dev_subsampled.jsonl")
        avoid_question_ids_file_path = dev_file_path if os.path.exists(dev_file_path) else None
        sample_size = args.sample_size
    if args.set_name == "dev_diff_size":
        avoid_question_ids_file_path = os.path.join("processed_data", args.dataset_name, args.dataset_name, "test_subsampled.jsonl")
        if args.dataset_name == 'hotpotqa':
            avoid_question_ids_file_path = os.path.join("processed_data", args.dataset_name, "test_subsampled.jsonl")
        sample_size = args.sample_size

    input_file_path = os.path.join("./datasets/QA/", args.dataset_name, args.dataset_name, "dev.jsonl")
    if args.dataset_name == 'hotpotqa':
        input_file_path = os.path.join("./datasets/QA/", args.dataset_name, "dev.jsonl")
    ...
    for instance in tqdm(instances):
        for context in instance["contexts"]:
            ...
            if args.dataset_name in ['hotpotqa', 'nq', 'trivia', 'squad']:
    ...
    if args.set_name == "dev_diff_size":
        output_file_path = os.path.join("processed_data", args.dataset_name, args.dataset_name, f"dev_{args.sample_size}_subsampled.jsonl")
        if args.dataset_name == 'hotpotqa':
        ...
        output_file_path = os.path.join("./datasets/QA/", args.dataset_name, args.dataset_name, f"{args.set_name}_subsampled.jsonl")
        if args.dataset_name == 'hotpotqa':
            output_file_path = os.path.join("./datasets/QA/", args.dataset_name, f"{args.set_name}_subsampled.jsonl")
        write_jsonl(instances, output_file_path)
